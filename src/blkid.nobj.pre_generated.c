...
#define obj_type_id_cache 0
#define obj_type_cache (obj_types[obj_type_id_cache])
  { NULL, 0, OBJ_TYPE_FLAG_WEAK_REF, "cache" },
  {NULL, -1, 0, NULL},
};
...
#define obj_type_cache_check(L, _index) \
	obj_udata_luacheck(L, _index, &(obj_type_cache))
#define obj_type_cache_optional(L, _index) \
	obj_udata_luaoptional(L, _index, &(obj_type_cache))
#define obj_type_cache_delete(L, _index, flags) \
	obj_udata_luadelete_weak(L, _index, &(obj_type_cache), flags)
#define obj_type_cache_push(L, obj, flags) \
	obj_udata_luapush_weak(L, (void *)obj, &(obj_type_cache), flags)




static const char *blkid_ffi_lua_code[] = { "local ffi=require\"ffi\"\n"
...
"\n"
"\n"
"local obj_type_cache_check\n"
"local obj_type_cache_delete\n"
"local obj_type_cache_push\n"
"\n"
"do\n"
"	local obj_mt, obj_type, obj_ctype = obj_register_ctype(\"cache\", \"cache *\")\n"
"\n"
"	function obj_type_cache_check(ptr)\n"
...
"		local bcaster = _obj_subs.cache[ctype]\n"
"		if bcaster then\n"
"			return bcaster(ptr)\n"
"		end\n"
"		return error(\"Expected 'cache *'\", 2)\n"
"	end\n"
"\n"
"	function obj_type_cache_delete(ptr)\n"
...
"	end\n"
"\n"
"	function obj_type_cache_push(ptr, flags)\n"
"		local id = obj_ptr_to_id(ptr)\n"
"		-- check weak refs\n"
...
"		return sformat(\"cache: %p, flags=%d\", self, nobj_obj_flags[obj_ptr_to_id(self)] or 0)\n"
"	end\n"
"\n"
"	-- type checking function for C API.\n"
"	_priv[obj_type] = obj_type_cache_check\n"
"	-- push function for C API.\n"
"	reg_table[obj_type] = function(ptr, flags)\n"
"		return obj_type_cache_push(ffi.cast(obj_ctype,ptr), flags)\n"
"	end\n"
"\n"
"	-- export check functions for use in other modules.\n"
"	obj_mt.c_check = obj_type_cache_check\n"
"	obj_mt.ffi_check = obj_type_cache_check\n"
"end\n"
"\n"
"\n"
...
"\n"
"C = ffi_load(\"blkid\",false)\n"
"\n"
"\n"
"-- Start \"cache\" FFI interface\n"
"_push.cache = obj_type_cache_push\n"
"ffi.metatype(\"cache\", _priv.cache)\n"
"-- End \"cache\" FFI interface\n"
"\n", NULL };


/* method: get */
static int cache__get__meth(lua_State *L) {
  size_t filename_len;
  const char * filename;
  int this_flags = OBJ_UDATA_FLAG_OWN;
  cache * this;
  filename = luaL_optlstring(L,1,"0",&(filename_len));
  ...
  obj_type_cache_push(L, this, this_flags);
  return 1;
}



static const luaL_Reg obj_cache_pub_funcs[] = {
  {"get", cache__get__meth},
  {NULL, NULL}
};

static const luaL_Reg obj_cache_methods[] = {
  {NULL, NULL}
};

static const luaL_Reg obj_cache_metas[] = {
  {"__tostring", obj_udata_default_tostring},
  {"__eq", obj_udata_default_equal},
  {NULL, NULL}
};

static const obj_base obj_cache_bases[] = {
  {-1, NULL}
};

static const obj_field obj_cache_fields[] = {
  {NULL, 0, 0, 0}
};

static const obj_const obj_cache_constants[] = {
  {NULL, NULL, 0.0 , 0}
};

static const reg_impl obj_cache_implements[] = {
  {NULL, NULL}
};

static const luaL_Reg blkid_function[] = {
  {NULL, NULL}
};

static const obj_const blkid_constants[] = {
  {NULL, NULL, 0.0 , 0}
};
...
static const reg_sub_module reg_sub_modules[] = {
  { &(obj_type_cache), REG_OBJECT, obj_cache_pub_funcs, obj_cache_methods, obj_cache_metas, obj_cache_bases, obj_cache_fields, obj_cache_constants, obj_cache_implements, 0},
...
#if LUAJIT_FFI
static const ffi_export_symbol blkid_ffi_export[] = {
  {NULL, { NULL } }
};
#endif
...
LUA_NOBJ_API int luaopen_blkid(lua_State *L) {
	...
	luaL_register(L, "blkid", blkid_function);
#else
	lua_newtable(L);
	luaL_setfuncs(L, blkid_function, 0);
#endif

	/* register module constants. */
	obj_type_register_constants(L, blkid_constants, -1, 0);
	...
	if(nobj_check_ffi_support(L)) {
		nobj_try_loading_ffi(L, "blkid.nobj.ffi.lua", blkid_ffi_lua_code,
			blkid_ffi_export, priv_table);
	}
#endif
